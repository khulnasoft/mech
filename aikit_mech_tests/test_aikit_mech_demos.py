"""Collection of tests for aikit mechanics demos"""
# global
import pytest


def test_demo_run_through(device, fw):
    from aikit_mech_demos.run_through import main
...
def test_demo_target_facing_rotation_vector(with_sim, device, fw):
    from aikit_mech_demos.interactive.target_facing_rotation_matrix import main
...
def test_demo_polar_to_cartesian_coords(with_sim, device, fw):
    from aikit_mech_demos.interactive.polar_to_cartesian_coords import main
