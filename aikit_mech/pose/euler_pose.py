...
# local
from aikit_mech.orientation import euler_angles as aikit_ea
...
def mat_pose_to_euler_pose(matrix, convention="zyx"):
    ...
    # BS x 3
    euler_angles = aikit_ea.rot_mat_to_euler(matrix[..., 0:3], convention)

    # BS x 6
    return aikit.concat([translation, euler_angles], axis=-1)
...
def quaternion_pose_to_euler_pose(quaternion_pose, convention="zyx"):
    ...
    # BS x 3
    euler_angles = aikit_ea.quaternion_to_euler(quaternion_pose[..., 3:], convention)
...
def axis_angle_pose_to_euler_pose(axis_angle_pose, convention="zyx"):
    ...
    # BS x 3
    euler_angles = aikit_ea.axis_angle_to_euler(axis_angle_pose[..., 3:], convention)
